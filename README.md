...
The parts are all divided up into variants under the main model name. All the types errors, non-existent vehicle additions & incorrect variant names (mostly from othe RUSForma mods) that were in files I got in the wild have been fixed.
