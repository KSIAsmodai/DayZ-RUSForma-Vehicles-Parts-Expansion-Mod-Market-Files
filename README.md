...
All the types errors, non-existent vehicle additions & incorrect variant names (mostly from other RUSForma mods) that were in files I got in the wild have been fixed.
