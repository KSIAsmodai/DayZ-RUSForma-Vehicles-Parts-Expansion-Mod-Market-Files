...
The parts are all divided up into variants under the main model name. All the types errors, non-existent vehicle additions & incorrect variant names (mostly from other RUSForma mods) that were in files I got in the wild have been fixed.
...
All you should need besides these files to install a RUSForma PARTS Trader is the mod itself: https://steamcommunity.com/sharedfiles/filedetails/?id=2536888090&searchtext=rusforma
